...
const PLATINUM_SPONSORS = [
  ...
  {
    name: "Red Bull",
    logo: "https://upload.wikimedia.org/wikipedia/en/thumb/f/f5/Red_Bull_Racing_logo.svg/1200px-Red_Bull_Racing_logo.svg.png",
  },
  {
    name: "Microsoft",
  ...
  {
    name: "Adobe",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Adobe_Corporate_Logo.svg/1024px-Adobe_Corporate_Logo.svg.png",
  },
];
...
const GOLD_SPONSORS = [
  {
    name: "Monster Energy",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Monster_Energy_logo.svg/800px-Monster_Energy_logo.svg.png",
  },
  {
    name: "Spotify",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Spotify_logo_with_text.svg/1200px-Spotify_logo_with_text.svg.png",
  },
  {
    name: "Coca Cola",
...
const SponsorCard = ({ name, logo }) => (
  <div className="flex flex-col items-center justify-center min-w-[240px] md:min-w-[400px] px-8 group">
    ...
    <span className="mt-8 text-[11px] font-black uppercase tracking-[0.5em] text-gray-300 group-hover:text-violet-300 transition-colors duration-500">
      {name}
    </span>
  </div>
);
...
export default function Sponsors() {
  return (
    <div className="pt-40 pb-20 min-h-screen overflow-hidden bg-[#030014] text-white">
      {/* Header */}
      <div className="max-w-full mx-auto px-6 mb-24">
        ...
        >
          <p className="text-violet-300 font-mono tracking-[0.2em] text-[20px] uppercase mb-4">
            Establishing Excellence
          </p>
          <h1 className="text-5xl md:text-[3rem] font-medium tracking-tighter italic leading-none">
            <span className="bg-gradient-to-r from-violet-500 via-purple-900 to-violet-400 bg-clip-text text-transparent">
              THE PARTNERS
            </span>
      ...
      <div className="space-y-32">
        ...
        <div className="space-y-6">
          <div className="max-w-full mx-auto px-6 flex flex-row-reverse items-center gap-4">
            <div className="w-12 h-[1px] bg-gradient-to-r from-violet-600 to-purple-600 shadow-[0_0_10px_rgba(139,92,246,0.7)]" />
            <p className="text-[12px] font-black text-gray-200 uppercase tracking-widest">
              Gold Tier Synergy
            </p>
          </div>
          <MarqueeTrack
      ...
      <div className="max-w-7xl mx-auto px-6 mt-48">
        <div className="glass-morphism p-16 md:p-32 rounded-[4rem] border border-white/5 text-center relative group overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-violet-600/10 blur-[140px]" />
          ...
          <p className="text-gray-200 max-w-xl mx-auto mb-12 text-sm md:text-lg font-light leading-relaxed relative z-10">
            Collaborate with the most anticipated fest of 2026. Empowering
            innovation and artistic brilliance.
          </p>
          <motion.button
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center justify-center px-16 py-6 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-bold text-[10px] uppercase tracking-widest rounded-full shadow-lg shadow-violet-500/30 hover:shadow-xl hover:shadow-violet-500/40 transition-shadow relative z-10"
          >
            Partnership Inquiry
          </motion.button>
        </div>
